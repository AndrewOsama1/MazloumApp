...
class _PaymentPageState extends State<PaymentPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar:MazloumAppBar(title: 'Payment',hasBack: true,isDetailed: true),
            ...
            child: Column(
              ...
              children: [
                ...
                AnimatedOpacity(
                  ...
                  child: InkWell(
                    onTap: ()=> Navigator.push(context, MaterialPageRoute(builder: (context) => CreditCardScreen())),
                    child: Container(
                ...
                SizedBox(height: 100,),
                 Row(
                  ...
                  children: [
                    ...
                    Text("${context.read<CartProvider>().cartItems.map((e) => e.price! * e.quantity!).reduce((value, element) => value + element)} L.E", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold))
                  ],
                ),
                SizedBox(height: 30),
